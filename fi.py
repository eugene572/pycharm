...
class TestUntitled():
  ...
  def test_untitled(self):
    ...
    self.driver.find_element(By.ID, "subject").send_keys("가나다라")
    self.driver.find_element(By.CSS_SELECTOR, "#publicSettingPart > td").click()
    self.driver.switch_to.frame(0)
    self.driver.find_element(By.ID, "ue_editorsource").click()
    self.driver.find_element(By.ID, "dext5_source_editor").click()
    self.driver.switch_to.default_content()
    self.driver.find_element(By.CSS_SELECTOR, "#stickableOption > td").click()
    self.driver.switch_to.frame(0)
    self.driver.find_element(By.CSS_SELECTOR, "html").click()
    self.driver.find_element(By.ID, "dext5_source_editor").send_keys("마바사")
    self.driver.switch_to.default_content()
    self.driver.find_element(By.CSS_SELECTOR, "#stickableOption > td").click()
